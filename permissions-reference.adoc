...
.2+| Gestionar la salida y el ingreso de grupos de seguridad para un sistema de archivos FSx para ONTAP | ec2:RevokeSecurityGroupIngress | Operaciones de gestión | Creación y eliminación de archivos 


| ec2:DeleteSecurityGroup | Operaciones de gestión | Creación y eliminación de archivos 


.17+| Cree, vea y gestione recursos del sistema de archivos FSx para ONTAP | fsx:CreateVolume | Operaciones de gestión | Operaciones y remediación 

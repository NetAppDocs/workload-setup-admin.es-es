...
El siguiente permiso ahora está disponible en el modo _READ_ para bases de datos `iam:SimulatePrincipalPolicy`: . El siguiente permiso ahora está disponible en el modo _Automate_ para GenAI: `bedrock:GetFoundationModel`.

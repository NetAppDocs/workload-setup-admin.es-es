...
| Permite que la fábrica de cargas de trabajo defina una política de retención de un día para los grupos de registros creados por la fábrica de cargas de trabajo para evitar la acumulación innecesaria de flujos de registro para las salidas de comandos SSM | Logs:PutRetentionPolicy  a| 
* Evaluación del almacenamiento (optimización)
* Inventario

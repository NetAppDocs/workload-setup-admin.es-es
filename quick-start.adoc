...
[role="quick-margin-para"]
Este paso es opcional. Puedes utilizar Workload Factory sin añadir credenciales para acceder a tu cuenta de AWS. Añadir credenciales de AWS a Workload Factory le da a tu cuenta de Workload Factory los permisos necesarios para crear y gestionar sistemas de archivos FSx for ONTAP y para implementar y gestionar cargas de trabajo específicas como bases de datos.

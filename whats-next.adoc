...
* https://docs.netapp.com/us-en/workload-builders/index.html["Cargas de trabajo del constructor"^]
+
Simplifique el consumo y el acceso a las versiones de software al permitir la integración instantánea de clones con sistemas de control de versiones y flujos de CI/CD, ahorrando tiempo y recursos.
